...
func (c *CosmWasmClient) GetAddr() (string, error) {
	return c.provider.Address()
}

func (c *CosmWasmClient) MustGetAddr() string {
...
func (c *CosmWasmClient) GetKeyring() keyring.Keyring {
...
func (c *CosmWasmClient) accessKeyWithLock(accessFunc func()) error {
